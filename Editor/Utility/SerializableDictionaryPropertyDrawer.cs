		...
		static bool CanPropertyBeExpanded(SerializedProperty property)
		{
			switch (property.propertyType)
			{
				case SerializedPropertyType.Generic:
                    if (EditorGUI.GetPropertyHeight(property) <= EditorGUIUtility.singleLineHeight)
                    {
                        return false;
                    }
                    else
