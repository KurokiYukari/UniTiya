...
namespace Sarachan.UniTiya.TiyaActor
{
    ...
    public class TiyaActorStateMachine : TiyaStateMachine, IActorActions
    {
        ...
        class ActorState : StateBase<IActorController>, IActorActions
        {
        ...
        class ActorFreeGroundStateGroup : ActorState
        {
        ...
        /// <summary>
        /// Idle 状态，代表站立闲置状态。属于状态组 <see cref="ActorFreeGroundStateGroup"/>。
        /// 是状态机的初始状态。
        /// </summary>
        class ActorIdleState : ActorState
        {
            public ActorIdleState(TiyaActorStateMachine stateMachine) : base(stateMachine, stateMachine[FREEGROUND_STATEGROUP])
            {
        ...
        /// </summary>
        class ActorLocomotionState : ActorState
        {
            public ActorLocomotionState(TiyaActorStateMachine stateMachine) : base(stateMachine, stateMachine[FREEGROUND_STATEGROUP])
            {
        ...
        /// FreeFall 状态
        /// </summary>
        class ActorFreeFallState : ActorState
        {
