...
namespace Sarachan.UniTiya
{
    ...
    public sealed class TiyaGameSystem : MonoBehaviour
    {
        ...
        /// 单例对象
        /// </summary>
        public static TiyaGameSystem Instance => _instance ? _instance : 
            throw new MissingComponentException($"There must be at least one instance of ${nameof(TiyaGameSystem)} component in this scene.");
        ...
        private void Start()
        {
            PlayerActor.GameObject.SetChildrenLayerTo(TiyaTools.TiyaLayers.Player, obj => obj.layer == 0);
        }
    }
}
